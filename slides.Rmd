---
title: "GitKraken"
subtitle: "Data Science for Economists"
author: "Boyoon Chang"
...
Git GUI stands for Graphic User Interface.

???
Git GUI stands for Graphic User Interface. GitKraken is one of the Git GUI, where you can easily view and track changes made by other contributors. 
...
- Include some photo that describes the relationship between github and gitkraken
- Get some image from the tutorial website
- Include source too
...
- It is one of the Git GUI. 
- More Description about GitKraken
...
# Link a GitHub repo to a GitKraken 
...
# Main Git operations and How it works on GitKraken
